...
## Apple WWDC26 Design Reference

Load `references/apple-wwdc26-design.md` when working on Apple-level product principles, search experiences, custom-control accessibility, agentic AI UX, or brand identity in app interfaces.
