...
Load `references/apple-wwdc26-design.md` when the Figma design includes Apple-platform patterns, search, custom controls, agentic AI states, branded app UI, or native-feeling product surfaces.
